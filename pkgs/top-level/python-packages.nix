...
self: super: with self; {
  ...
  casadi-bindings = callPackage ../development/python-modules/casadi { };
  ...
  clang-bindings = callPackage ../development/python-modules/clang { };
  ...
  nlopt-bindings = callPackage ../development/python-modules/nlopt { };
